        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <ElegantShape
                    ...
                    height={80}
                    rotate={-8}
                    gradient="from-satellite-deep/[0.15]"
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-white/90 to-green-300"
                                )}
                            >
                                {title2}
                            </span>
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
                            ...
                            Compare before and after images to identify environmental, urban, or natural changes with comprehensive reports.
                        </p>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-bold text-green-400 mb-2">&lt;3s</div>
                            <div className="text-white/60 text-sm">Analysis Time</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl md:text-4xl font-bold text-emerald-400 mb-2">AI</div>
                            <div className="text-white/60 text-sm">Powered Reports</div>
                        </div>
                    </motion.div>
                </div>
            </div>
